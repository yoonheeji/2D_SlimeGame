...
public class PlayerController : CreatureController
{
    ...
    public int SkillRefreshCount
    {
        ...
        set
        {
            Managers.Game.ContinueInfo.SkillRefreshCount = value;
        }
    }
    ...
    public override void InitSkill()
    {
        ...
        //장비 스킬 추가
        Equipment item;
        Managers.Game.EquippedEquipments.TryGetValue(EquipmentType.Weapon, out item);
        if (item != null)
        {
            // 베이스 스킬
            SkillType type = Util.GetSkillTypeFromInt(item.EquipmentData.BasicSkill);
    ...
    {
        //CreatureState = CreatureState.Knockback;

        //RigidBody.velocity = Vector2.zero;

        //RigidBody.AddForce(dir * 3, ForceMode2D.Impulse);
